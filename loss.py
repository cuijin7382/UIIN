...
class LossFunction(nn.Module):
    def __init__(self):
        ...
        # self.P_Loss=PerceptualLoss({'conv1_2': 1, 'conv2_2': 1, 'conv3_4': 1, 'conv4_4': 1}, perceptual_weight=1e-2,criterion='mse')

        self.P_weight= 1e-2
    def forward(self, input, illu):
        # print(illu.shape)
        # loss_hvi = 1.5* self.l2_loss(illu, l1) +   self.smooth_loss(input, illu)
        # return loss_hvi
        Fidelity_Loss = self.l2_loss(illu, input)
        Smooth_Loss = self.smooth_loss(input, illu)
        L1=self.L1_loss(input, illu)
